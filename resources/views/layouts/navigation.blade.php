        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('grupo-investigacion')" :active="request()->routeIs('grupo-investigacion')">
                        {{ __('Grupos de Investigación') }}
                    </x-nav-link>
                    <x-nav-link :href="route('productos-investigativos.index')" :active="request()->routeIs('productos-investigativos.*')">
                        {{ __('Productos Investigativos') }}
                    </x-nav-link>
                            ...
                            <x-slot name="content">
                                ...
                                <div class="w-48">
                                    <x-dropdown-link href="{{ route('dashboard') }}">
                                        {{ __('Sub Tipo Productos') }}
                                    </x-dropdown-link>
                                    <x-dropdown-link href="{{ route('dashboard') }}">
                                        {{ __('Tipo Producto') }}
                                    </x-dropdown-link>
                                    <x-dropdown-link href="{{ route('parametros.periodos.index') }}">
                                        {{ __('Periodos') }}
                                    </x-dropdown-link>
